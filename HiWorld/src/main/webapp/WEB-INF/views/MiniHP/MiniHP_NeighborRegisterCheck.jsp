...
function neighborRegister_no(){
 ...
 <body background="${resoucePath }/imgages/admin/member_check.jpg">
	<form action="" name="neighborRegistorCheck" method="post">
		...
		<span style="position: absolute; top:420px; left:115px; font-size:8pt;">
			<img alt="" src="${resoucePath}/images/admin/yesBtn.jpg" onclick="neighborRegistor_ok();"/>
		</span>
		<span style="position: absolute; top:420px; left:155px; font-size:8pt;">
			<img alt="" src="${resoucePath}/images/admin/nextBtn.jpg" onclick="neighborRegistor_next();"/>
		</span>
		<span style="position: absolute; top:420px; left:205px; font-size:8pt;">
			<img alt="" src="${resoucePath}/images/admin/noBtn.jpg" onclick="neighborRegistor_no();"/>
		</span>	
