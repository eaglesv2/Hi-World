		...
		<table id="menuUpdatePicture">
			...
			<tbody>
				<tr height="20">
					...
					<td><input type="text" name="title" id="title" value="${picture.title}"></td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					...
					<td>
						...
						<c:choose>
							...
							<c:otherwise>
								<input type="file" name="file1" id="file" onchange="fileCheck(this)" accept="image/gif,image/jpeg,image/png">
							</c:otherwise>
						</c:choose>
						</div>
					</td>
