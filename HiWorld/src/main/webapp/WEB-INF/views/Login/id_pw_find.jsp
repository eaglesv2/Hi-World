			...
			<div class="">
				...
				<div id="">
					<div class="">
						...
						<div>
							<input type="text" class="" id="" name="" placeholder="ex) 갓형배">
						</div>
					</div>
					<div class="">
						<label class="" for="inputPhone_1">휴대폰번호</label>
						<div>
							<input type="text" class="" id="" name="" placeholder="ex) 010-7777-9999">
						</div>
					</div>
					<div class="">
						<button id="" type="button" onclick="" class="">확인</button>
					<a class=""	href="">취소</a>
					</div>
				</div>
