...
public class MiniHpPictureContoller {
	...
	public String miniHpPictureSide(Model model, HttpSession session) {
		System.out.println("MiniHpPicutreSide.do");
	...
	//폴더 추가
	@PostMapping("/MiniHpPicutreSide.do")
	@ResponseBody
	...
	//폴더 삭제
	@DeleteMapping("/MiniHpPicutreSide.do/{serial}")
	@ResponseBody
	...
	//폴더 수정
	@PutMapping("/MiniHpPicutreSide.do/{serial}/{folderName}/{scope}")
	@ResponseBody
